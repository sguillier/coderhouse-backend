...
app.use(
  session({
    ...
    cookie: {
      // Esto alguna vez no me resulto pero aqui anda barbaro
      maxAge: 6000,
    },
  })
)
...
app.use((req, res, next) => {
  // Aqui se define el "objeto" isAuthenticated sobre req, que en realidad no es objeto es funcion
  // Lo interesante de esto es que se puede usar req.isAuthenticated() en todas las rutas
  req.isAuthenticated = () => {
